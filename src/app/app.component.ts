...
export class AppComponent {
	...
	why = [
		{
			title: 'Be a leader',
			content: "Represent your college as you help organize one of Asia's largest cultural fests",
			icon: 'fa fa-user'
		},
		{
			title: 'Networking',
			content: 'Get opportunities to interact with celebrities from various fields',
	...
	incentive = [
		{
			title: 'Certification',
			content: 'Certificate of appreciation from Antaragni’19, IIT Kanpur recognizing your hardwork.',
			icon: 'fa fa-trophy'
		},
		{
			title: 'Accomodation',
			content: 'Free accommodation for the top-performing campus ambassadors @ Antaragni 2019',
			icon: 'fa fa-home'
		},
		{
	...
	FAQS = [
		{
			...
			answer: 'If you are a college student with a valid college ID, then you are good to go.'
		},
		{
			question: 'How to become a Campus Ambassador?',
			answer: 'You need to visit ca.antaragni.in and register yourself by providing the required details.'
		},
		{
	...
	responsibilities = [
		...
		{
			title: 'COORDINATE',
			content: 'Collaborate with the Antaragni team in organising on-ground events in your city.'
		}
	];
}
